...
{
    public partial class Manage_News : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ContactAdvertise = table.Column<string>(type: "nvarchar(max)", maxLength: 2147483647, nullable: false),
                    ExtraProperties = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ConcurrencyStamp = table.Column<string>(type: "nvarchar(40)", maxLength: 40, nullable: true),
                    CreationTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatorId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AccessSuccessCount = table.Column<int>(type: "int", nullable: false),
                    ExtraProperties = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ConcurrencyStamp = table.Column<string>(type: "nvarchar(40)", maxLength: 40, nullable: true),
                    CreationTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatorId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppActiveUsers", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AppActiveUsers_AbpUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AbpUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppEventses", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AppEventses_AppCategories_CategoryId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppOders", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AppOders_AbpUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AbpUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AppOders_AppServices_ServiceId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NewsHot = table.Column<int>(type: "int", nullable: false),
                    Date = table.Column<DateTime>(type: "datetime2", nullable: false),
                    Status = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AppNews_AbpUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AbpUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AppNews_AppCities_CityId",
                        column: x => x.CityId,
                        principalTable: "AppCities",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AppNews_AppEventses_EventId",
                        column: x => x.EventId,
                        principalTable: "AppEventses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AppNews_AppTopics_TopicId",
                        column: x => x.TopicId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppAdvertises", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AppAdvertises_AppOders_OrderId",
                        column: x => x.OrderId,
                        principalTable: "AppOders",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_AppComments_AppNews_NewsId",
                        column: x => x.NewsId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_AppRatings_AppNews_NewsId",
                        column: x => x.NewsId,
                        principalTable: "AppNews",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    NewsId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    check = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: false),
                    Date = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ExtraProperties = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ConcurrencyStamp = table.Column<string>(type: "nvarchar(40)", maxLength: 40, nullable: true),
                    CreationTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppSaves", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AppSaves_AbpUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AbpUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_AppSaves_AppNews_NewsId",
                        column: x => x.NewsId,
                        principalTable: "AppNews",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppActiveUsers_UserId",
                table: "AppActiveUsers",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_AppAdvertises_OrderId",
                table: "AppAdvertises",
                column: "OrderId");

            migrationBuilder.CreateIndex(
                name: "IX_AppComments_NewsId",
                table: "AppComments",
                column: "NewsId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppEventses_CategoryId",
                table: "AppEventses",
                column: "CategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_AppNews_CityId",
                table: "AppNews",
                column: "CityId");

            migrationBuilder.CreateIndex(
                name: "IX_AppNews_EventId",
                table: "AppNews",
                column: "EventId");

            migrationBuilder.CreateIndex(
                name: "IX_AppNews_TopicId",
                table: "AppNews",
                column: "TopicId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppOders_ServiceId",
                table: "AppOders",
                column: "ServiceId");

            migrationBuilder.CreateIndex(
                name: "IX_AppOders_UserId",
                table: "AppOders",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_AppRatings_NewsId",
                table: "AppRatings",
                column: "NewsId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppSaves_NewsId",
                table: "AppSaves",
                column: "NewsId");

            migrationBuilder.CreateIndex(
                name: "IX_AppSaves_UserId",
                table: "AppSaves",
                column: "UserId");
