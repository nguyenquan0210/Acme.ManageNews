...
{
    [DbContext(typeof(ManageNewsDbContext))]
    partial class ManageNewsDbContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Acme.ManageNews.Entities.ActiveUser", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");

                    b.Property<int>("AccessSuccessCount")
                        .HasColumnType("int");
                    ...
                    b.ToTable("AppActiveUsers", (string)null);
                });

            modelBuilder.Entity("Acme.ManageNews.Entities.Advertise", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("AppAdvertises", (string)null);
                });

            modelBuilder.Entity("Acme.ManageNews.Entities.Category", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Acme.ManageNews.Entities.City", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Acme.ManageNews.Entities.Comment", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Acme.ManageNews.Entities.Contact", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("ContactAdvertise")
                        .IsRequired()
                        .HasMaxLength(2147483647)
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Acme.ManageNews.Entities.Events", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("AppEventses", (string)null);
                });

            modelBuilder.Entity("Acme.ManageNews.Entities.News", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Acme.ManageNews.Entities.Order", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("AppOders", (string)null);
                });

            modelBuilder.Entity("Acme.ManageNews.Entities.Rating", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Acme.ManageNews.Entities.Save", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("AppSaves", (string)null);
                });

            modelBuilder.Entity("Acme.ManageNews.Entities.Services", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Acme.ManageNews.Entities.Topic", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Acme.ManageNews.Entities.Advertise", b =>
                {
                    b.HasOne("Acme.ManageNews.Entities.Order", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Acme.ManageNews.Entities.Comment", b =>
                {
                    b.HasOne("Acme.ManageNews.Entities.News", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Acme.ManageNews.Entities.Events", b =>
                {
                    b.HasOne("Acme.ManageNews.Entities.Category", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Acme.ManageNews.Entities.News", b =>
                {
                    b.HasOne("Acme.ManageNews.Entities.City", null)
                        .WithMany()
                        .HasForeignKey("CityId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Acme.ManageNews.Entities.Events", null)
                        .WithMany()
                        .HasForeignKey("EventId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Acme.ManageNews.Entities.Topic", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Acme.ManageNews.Entities.Order", b =>
                {
                    b.HasOne("Acme.ManageNews.Entities.Services", null)
                        .WithMany()
